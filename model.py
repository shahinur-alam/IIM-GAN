...
class Generator(nn.Module):
    def __init__(self, scale_factor):
        ...
        block12 = [UpsampleBLock(64, 2) for _ in range(upsample_block_num)]
        block12.append(nn.Conv2d(64, 3, kernel_size=9, padding=4))
    ...
    def forward(self, x):
        ...
        block12 = self.block12(block1 + block11)

        return (torch.tanh(block12) + 1) / 2
